    ...
    return (function () {
        ...
        var a = {
                isEnabled: function () {
                    var t;
                    return (
                        null === (t = window.TAGIFY_DEBUG) || void 0 === t || t
                    );
                },
                log: function () {
                    for (
                    ...
                    var n;
                    this.isEnabled() &&
                        (n = console).log.apply(n, ["[Tagify]:"].concat(s(e)));
                },
                warn: function () {
                    for (
                        var t = arguments.length, e = new Array(t), i = 0;
                    ...
                    var n;
                    this.isEnabled() &&
                        (n = console).warn.apply(n, ["[Tagify]:"].concat(s(e)));
                },
            },
            o = function (t, e, i, n) {
                return (
        ...
        function w(t) {
            return (
                (null == t
                    ? void 0
                    : t.closest(this.settings.classNames.namespaceSelector)) ===
                this.DOM.scope
            );
        }
        function T(t, e) {
        ...
        function O(t, e, i) {
            return t
                ? (e &&
                      (t.__tagifyTagData = i
                          ? e
                          : h({}, t.__tagifyTagData || {}, e)),
                  t.__tagifyTagData)
                : (a.warn("tag element doesn't exist", { tagElm: t, data: e }),
                  e);
        }
        function x(t) {
            if (t && t.parentNode) {
        ...
        function D(t, e) {
            t.forEach(function (t) {
                if (O(t.previousSibling) || !t.previousSibling) {
                    var i = document.createTextNode("â€‹");
                    t.before(i), e && x(i);
                }
            });
        }
                    ...
                    {},
                    {
                        ...
                        filterListItems: function (t, e) {
                            ...
                            return (
                                ...
                                (O = y
                                    ? u.sortby(p.concat(h), r)
                                    : p.concat(h).slice(0, v)),
                                    ...
                                    return (
                                        (n =
                                            ...
                                            e.settings.dropdown.escapeHTML
                                                ? u(n)
                                                : n),
                                        e.settings.templates.dropdownItem.apply(
                                            e,
                                            [E(M({}, t), { mappedValue: n }), e]
                                        )
                                    );
                                })
                                .join("");
                    ...
                    (k = {
                        ...
                        show: function (t) {
                            ...
                            if (
                                ...
                                !(
                                    (l &&
                                        !r &&
                                        !a.templates.dropdownItemNoMatch) ||
                                ...
                                if (
                                    ...
                                    t &&
                                        ...
                                        a.templates.dropdownItemNoMatch &&
                                            (n =
                                                a.templates.dropdownItemNoMatch.call(
                                                    this,
                                                    { value: t }
                                                ))),
                                    !n)
                        ...
                        hide: function (t) {
                            var e = this,
                                ...
                                a =
                                    "manual" ==
                                        this.settings.dropdown.position && !t;
                            ...
                            return (
                                !1 === s.dropdown.enabled ||
                                    ...
                                    document.body.contains(this.DOM.dropdown) ||
                                        ...
                                        setTimeout(function () {
                                            return i.DOM.dropdown.classList.remove(
                                                s.classNames.dropdownInital
                                            );
                                        }))),
                                this
            ...
            V = {
                wrapper: function (t, e) {
                    return '<tags class="'
                        ...
                        .concat(
                            e.mode
                                ? "".concat(e.classNames[e.mode + "Mode"])
                                : "",
                            " "
                        )
                        .concat(t.className, '"\n                    ')
        ...
        var K = {
                    ...
                    this.listeners.global = this.listeners.global || [
                        {
                            ...
                            cb: i[this.isIE ? "onInputIE" : "onInput"].bind(
                                this
                            ),
                        },
                        {
            ...
            callbacks: {
                onFocusBlur: function (t) {
                    ...
                    var d = t.target
                            ? this.trim(this.DOM.input.textContent)
                            : "",
                        c =
                            null === (i = this.value) ||
                            void 0 === i ||
                                ...
                                .then(function (s) {
                                    ...
                                    switch (t.key) {
                                        ...
                                        case "Tab":
                                            return !0;
                                        case "Enter":
                                            if (e.state.dropdown.visible && !f)
                                                return;
                                            t.preventDefault();
                                            var b =
                                                e.state.autoCompleteData || n;
                                            setTimeout(function () {
                                                (e.state.dropdown.visible &&
                                                    !f) ||
                                                    e.state.actions
                ...
                onMixTagsInput: function (t) {
                    ...
                    if (
                        ...
                        if (
                            ...
                            (n =
                                (e = f.toString().slice(0, f.endOffset)).split(
                                    c.pattern
                                ).length - 1),
                            (i = e.match(c.pattern)) &&
                ...
                onPaste: function (t) {
                    ...
                    var i,
                        ...
                        a = this.settings;
                    if (
                        ("select" == a.mode && a.enforceWhitelist) ||
                        !a.userInput
                    )
                        return !1;
                    a.readonly ||
                ...
                onEditTagInput: function (t, e) {
                    ...
                    this.editTagChangeDetected(h(a, r)) ||
                        !0 !== t.originalIsValid ||
                        (l = !0),
                        n.classList.toggle(
                        ...
                        o.length >= this.settings.dropdown.enabled &&
                            (this.state.editing &&
                                (this.state.editing.value = o),
                            this.dropdown.show(o)),
                        this.trigger("edit:input", {
                            tag: n,
                            index: s,
                            data: h({}, this.value[s], { newValue: o }),
                            event: e,
                        });
                },
                    ...
                    t.forEach(function (t) {
                        t.addedNodes.forEach(function (t) {
                            if ("<div><br></div>" == t.outerHTML)
                                ...
                                1 == t.nodeType &&
                                t.querySelector(
                                    e.settings.classNames.tagSelector
                                )
                            ) {
                                var i,
        ...
        ($.prototype = {
            ...
            applySettings: function (t, e) {
                ...
                if (
                    ...
                    ["whitelist", "blacklist"].forEach(function (e) {
                        ...
                        i &&
                            X((i = i.split(a.delimiters)), Array) &&
                            (a[e] = i);
                    }),
                    "autoComplete" in e &&
                        !g(e.autoComplete) &&
                        ((a.autoComplete = S.autoComplete),
                ...
                if ((!c && this.dropdown.hide(), s)) {
                    if (!X(r, Object) || !("editable" in r) || r.editable)
                        return (
                            ...
                            s.addEventListener(
                                "input",
                                l.onEditTagInput.bind(this, s)
                            ),
                            s.addEventListener(
                                "paste",
                                l.onEditTagPaste.bind(this, s)
                            ),
            ...
            replaceTag: function (t, e) {
                (e && "" !== e.value && void 0 !== e.value) ||
                    ...
                    e.__isValid &&
                        1 != e.__isValid &&
                        h(e, this.getInvalidTagAttrs(e, e.__isValid));
            ...
            getTagElms: function () {
                ...
                var n =
                    "." +
                    G(this.settings.classNames.tag.split(" "))
                        .concat(G(e))
                        .join(".");
            ...
            getTagIndexByValue: function (t) {
                ...
                return (
                    this.getTagElms().forEach(function (s, a) {
                        s.__tagifyTagData &&
                            o(e.trim(s.__tagifyTagData.value), t, n) &&
                            i.push(a);
                    }),
                    i
                );
            ...
            getWhitelistItem: function (t, e, i) {
                ...
                return (
                    (i = i || s.whitelist).some(function (i) {
                        ...
                        if (o(a, t, s.dropdown.caseSensitive, s.trim))
                            return (
                    ...
                    n ||
                        "value" != e ||
                        "value" == s.tagTextProp ||
                        (n = this.getWhitelistItem(t, s.tagTextProp, i)),
                    n
                );
            },
            ...
            prepareNewTagNode: function (t, e) {
                ...
                if (
                    ...
                    if (
                        (h(s, this.getInvalidTagAttrs(t, t.__isValid), {
                            __preInvalidData: a,
                        }),
