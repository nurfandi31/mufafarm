                ...
                8764: function (e) {
                    (e.exports = (function () {
                        ...
                        const r = 100,
                            ...
                            w = (e) =>
                                v(e) ? e.toPromise() : Promise.resolve(e),
                            C = (e) => e && Promise.resolve(e) === e,
                            A = () =>
                                document.body.querySelector(`.${u.container}`),
                            k = (e) => {
                                const t = A();
                            ...
                            U = () =>
                                Y(document.body, u.shown) &&
                                !Y(document.body, u["toast-shown"]) &&
                                !Y(document.body, u["no-backdrop"]),
                            z = () => {
                                const e = B();
                            ...
                            X = (e, t) => {
                                ...
                                switch (t) {
                                    ...
                                    case "checkbox":
                                        return e.querySelector(
                                            `.${u.popup} > .${u.checkbox} input`
                                        );
                                    case "radio":
                                        return (
                                            e.querySelector(
                                                `.${u.popup} > .${u.radio} input:checked`
                                            ) ||
                                            e.querySelector(
                                                `.${u.popup} > .${u.radio} input:first-child`
                                            )
                                        );
                                    case "range":
                                        return e.querySelector(
                                            `.${u.popup} > .${u.range} input`
                                        );
                                    default:
                                        return e.querySelector(
                                            `.${u.popup} > .${u.input}`
                        ...
                        (We.text =
                            ...
                            (We.select = (e, t) => {
                                if (
                                    ((e.textContent = ""), t.inputPlaceholder)
                                ) {
                            ...
                            (We.checkbox = (e, t) => {
                                ...
                                return (
                                    W(o, t.inputPlaceholder || t.inputLabel), n
                                );
                            }),
                            (We.textarea = (e, t) => {
                        ...
                        const Ye = (e, t) => {
                            ...
                            Je = (e, t) => {
                                ...
                                if (o) {
                                    if (n && t.icon === n.icon)
                                        return tt(o, t), void Xe(o, t);
                                    if (t.icon || t.iconHtml) {
                                        if (
                                            t.icon &&
                                            -1 ===
                                                Object.keys(d).indexOf(t.icon)
                                        )
                                            return (
                                                h(
                            ...
                            ot = (e) =>
                                `<div class="${u["icon-content"]}">${e}</div>`,
                            it = (e, t) => {
                                const n = T();
                                n &&
                                    (t.imageUrl
                            ...
                            ct = (e) => {
                                ...
                                return (
                                    ...
                                    e.progressStepsDistance &&
                                        oe(t, "width", e.progressStepsDistance),
                                    t
                                );
                            },
                            ut = (e, t) => {
                        ...
                        const Vt = (e) => {
                            ...
                            _t = () => {
                                null !== qt &&
                                    ((document.body.style.paddingRight = `${qt}px`),
                                    (qt = null));
                            };
                        function Nt(e, t, n, o) {
                        ...
                        const Kt = (e) => {
                            ...
                            Yt = (e, t, n) => {
                                ...
                                "function" == typeof n.willClose &&
                                    n.willClose(t),
                                    null === (o = s.eventEmitter) ||
                                        void 0 === o ||
                                        o.emit("willClose", t),
                                    r
                                        ? Zt(e, t, i, n.returnFocus, n.didClose)
                                        : Nt(e, i, n.returnFocus, n.didClose);
                            },
                            Zt = (e, t, n, o, i) => {
                                s.swalCloseEventFinishedCallback = Nt.bind(
                                    null,
                                    e,
                                    n,
                                    o,
                        ...
                        const cn = (e) => {
                            ...
                            hn = (e, t) => {
                                ...
                                if (!n.input)
                                    return void h(
                                        `The "input" parameter is needed to be set when using returnInputValueOn${p(
                                            t
                                        )}`
                                    );
                                const o = e.getInput(),
                        ...
                        const bo = (e) => {
                            for (
                                ...
                                for (const e in go) {
                                    ...
                                    if (n)
                                        return void go[e].fire({ template: n });
                                }
                        };
                        class yo {
                            constructor() {
                        ...
                        function Fo(e) {
                            e.inputValidator ||
                                ("email" === e.input &&
                                    (e.inputValidator = No.email),
                                "url" === e.input &&
                                    (e.inputValidator = No.url));
                        }
                        function Ro(e) {
                            (!e.target ||
                            ...
                            _main(e) {
                                let t =
                                    ...
                                    void 0 !== arguments[1]
                                        ...
                                        : {};
                                if (
                                    (Nn(Object.assign({}, t, e)),
                                    s.currentInstance)
                                ) {
                                    const e = Pt.swalPromiseResolve.get(
                                            s.currentInstance
                                        ),
                                        { isAwaitingPromise: t } =
                                            s.currentInstance;
                                ...
                                Uo(n),
                                    Object.freeze(n),
                                    s.timeout &&
                                        (s.timeout.stop(), delete s.timeout),
                        ...
                        const Yo = (e, t, n) =>
                            ...
                            Go = (e, t) => {
                                if (!t.toast)
                                    return y(t.allowEnterKey)
                                        ? void (Qo(e) || ei(e, t) || vt(-1, 1))
                                        : (b("allowEnterKey"), void ti());
                            },
                            Qo = (e) => {
                                const t = Array.from(
