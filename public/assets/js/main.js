        ...
        (() => {
            ...
            if (
                ...
                "undefined" != typeof Waves &&
                    ...
                    Waves.attach(
                        "[class*='btn-outline-']:not(.position-relative)"
                    ),
                    Waves.attach(
                        "[class*='btn-label-']:not(.position-relative)"
                    ),
                    Waves.attach(
                        "[class*='btn-text-']:not(.position-relative)"
                    ),
                    Waves.attach(
            ...
            0 < a.length &&
                ...
                window
                    ...
                    .addEventListener("change", () => {
                        ...
                        "light" !== e &&
                            "dark" !== e &&
                            window.Helpers.setTheme(
                                window.Helpers.getPreferredTheme()
                            );
                    }),
                s(),
                window.addEventListener("DOMContentLoaded", () => {
                    window.Helpers.showActiveTheme(
                        window.Helpers.getPreferredTheme()
                    ),
                        s(),
                ...
                for (let e = 0; e < l.length; e++)
                    l[e].addEventListener("click", function () {
                        ...
                        for (var e of this.parentNode.children)
                            for (
                                var t = e.parentElement.parentNode.firstChild;
                                t;
                    ...
                    ? ((document.body.style.overflow = "hidden"),
                      ...
                      window.autoCompletePS ||
                          ((n = document.querySelector(".aa-Panel")) &&
                              (window.autoCompletePS = new PerfectScrollbar(
                                  n
                              ))))
